...
const fullImportRegex = /from "react-bootstrap";$/gm;
const memberImportRegex = /from "react-bootstrap\/lib\/.+";$/gm;
const fullImportStyleRegex = /from "react-bootstrap\/lib\/style\.css";$/gm;
const memberImportStyleRegex = /from "react-bootstrap\/lib\/.+\/style\.css"\);$/gm;
...
describe('Transform CommonJS', function() {
  ...
  describe('General behavior', () => {
    ...
    equal(occurrences(fullImportRegex, code), 1, 'number of full imports should be 1');
    equal(occurrences(memberImportRegex, code), 0, 'number of member imports should be 0');
    equal(occurrences(fullImportStyleRegex, code), 0, 'number of member imports with style should be 0');
    equal(occurrences(memberImportStyleRegex, code), 0, 'number of member imports with style should be 0');
  ...
  it('should handle member imports', async ()=> {
    const input = `
  ...
  equal(occurrences(fullImportRegex, code), 0, 'number of full imports should be 0');
  equal(occurrences(memberImportRegex, code), 2, 'number of member imports should be 2');
  equal(occurrences(fullImportStyleRegex, code), 0, 'number of member imports with style should be 0');
  equal(occurrences(memberImportStyleRegex, code), 0, 'number of member imports with style should be 0');
});

it('should handle a mix of member and default import styles', async ()=> {
  const input = `
  import Bootstrap, { Grid, Row as row } from "react-bootstrap";
  `;
